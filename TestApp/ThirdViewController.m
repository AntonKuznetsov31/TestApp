...
- (void)viewDidLoad {
    ...
    self.questionLabel.text = [[Test sharedInstance].questions objectAtIndex:2];
}
...
- (IBAction)nextButtonPressed:(UIButton *)sender {
    [self shouldPerformSegueWithIdentifier:@"fourthSegue" sender:self];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell) {
        ...
        NSArray *answersArray = [[Test sharedInstance].answers objectForKey: [NSNumber numberWithInteger:2]];

...
- (void)viewDidLoad {
    ...
    self.questionLabel.text = [[Test sharedInstance].questions objectAtIndex:0];
...
- (IBAction)nextButtonPressed:(UIButton *)sender {
    [self shouldPerformSegueWithIdentifier:@"secondSegue" sender:self];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell) {
        ...
        NSArray *answersArray = [[Test sharedInstance].answers objectForKey: [NSNumber numberWithInteger:0]];
